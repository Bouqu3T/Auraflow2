...
const EditProfilePage = () => {
  ...
  const defaultProfile = mockProfiles[profileId] || mockProfiles['1'];
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      localStorage.setItem('auraflow_profiles', JSON.stringify([mockProfiles['1'], mockProfiles['2']]));
      alert('档案保存成功！');
      setIsLoading(false);
      router.push('/profile');
    }, 500);
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] p-4">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-xl font-medium text-[#333333]">编辑档案</h1>
      </div>
